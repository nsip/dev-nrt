...
//
// Variation on ItemPrinintg with cut-down set of
// info; item, student, score
//
func NswItemPrintingReport() *NswItemPrinting {

	r := NswItemPrinting{}
	r.initialise("./config/NswItemPrinting.toml")
	r.printStatus()
...
//
//
func (r *NswItemPrinting) calculateFields(eor *records.EventOrientedRecord) []byte {
