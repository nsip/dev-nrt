...
//
//
func (r *QaSystemCodeframe) calculateFields(cfr *records.CodeframeRecord) []byte {
	...
	cf, _ = sjson.SetBytes(cf, "CalculatedFields.NAPTestlet.TestletContent.NAPTestletLocalId", testletlocalid)
